(define (domain libraryworld)
    ...
    (:action check-out
     ...
     (:action remove-from-shelf
        ...
        :precondition (and (hands-free) (on-shelf ?book ?underneath-book) (accessible ?book))
        :effect (and (not (on-shelf ?book ?underneath-book)) (accessible ?underneath-book) (holding ?book))
    )
     (:action return-book
        :parameters (?book - book)
