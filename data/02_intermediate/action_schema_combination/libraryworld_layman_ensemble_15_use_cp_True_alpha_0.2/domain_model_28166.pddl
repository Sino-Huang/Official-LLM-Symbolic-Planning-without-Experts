(define (domain libraryworld)
    ...
    (:action check-out
     ...
     (:action take-from-table
        ...
        :effect (and (not (on-table ?book)) (not (accessible ?book)) (holding ?book))
    )
)