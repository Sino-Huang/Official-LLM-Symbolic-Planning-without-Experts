...
from tarski.syntax import land, lor, CompoundFormula, Atom
...
def main(domain1_name, problem1_name, domain2_name, problem2_name, merged_domain, merged_problem):
    ...
    for action in domain1_actions:
        ...
        if isinstance(domain2_precond, Atom):
            domain2_precond_subformulas = [domain2_precond]
        else:
            domain2_precond_subformulas = domain2_precond.subformulas
        for neg_dom2_p in domain2_precond_subformulas:
            remove = '( ,?)'
            ...
            if isinstance(domain2_precond, Atom):
                domain2_precond_subformulas_l = [domain2_precond]
            else:
                domain2_precond_subformulas_l = domain2_precond.subformulas    
                
            for dom2_p in domain2_precond_subformulas_l:
    ...
    for action in domain2_actions:
        ...
        if isinstance(domain1_precond, Atom):
            domain1_precond_subformulas = [domain1_precond]
        else:
            domain1_precond_subformulas = domain1_precond.subformulas    
            
        for neg_dom1_p in domain1_precond_subformulas:
            remove = '( ,?)'
            ...
            if isinstance(domain1_precond, Atom):
                domain1_precond_subformulas_l = [domain1_precond]
            else:
                domain1_precond_subformulas_l = domain1_precond.subformulas    
                
            for dom1_p in domain1_precond_subformulas_l:
